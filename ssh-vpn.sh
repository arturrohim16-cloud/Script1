...
"https://github.com/arturrohim16-cloud/Master/tree/bf32992f502103e884009aa986a7f2a5d1ab4bcc/websocket"
...
curl https://raw.githubusercontent.com/arturrohim16-cloud/Master/refs/heads/main/ssh/vps.conf > /etc/nginx/conf.d/vps.conf
...
# Install Stunnel 5
cd /root/
wget -q -O stunnel5.sh "https://raw.githubusercontent.com/arturrohim16-cloud/Script1/refs/heads/main/stunnel5.sh"
unzip -o stunnel5.sh
cd /root/stunnel
chmod +x configure
